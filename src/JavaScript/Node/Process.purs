...
foreign import _lookupEnv :: String -> Effect (Nullable String)

lookupEnv :: String -> Effect (Maybe String)
lookupEnv variableName = _lookupEnv variableName <#> toMaybe
...
foreign import _onSignal :: String -> Effect Unit -> Effect Unit
